...
public class EventHouseSinkTask extends SinkTask {
     ...
     */
    private static void validateTableAccess(Client engineClient, TopicToTableMapping mapping, FabricSinkConfig config, List<String> databaseTableErrorList,
    ...
    void validateTableMappings(@NotNull FabricSinkConfig config) {
