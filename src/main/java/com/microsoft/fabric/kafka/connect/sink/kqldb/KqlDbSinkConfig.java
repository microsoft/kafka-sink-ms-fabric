...
public class KqlDbSinkConfig extends AbstractConfig {
    ...
    private static final String KQL_DB_CONNECTION_STRING_DISPLAY = "Eventhouse Connection String (Connection string to the KQL DB on fabric)";
    ...
    private static final Logger log = LoggerFactory.getLogger(KqlDbSinkConfig.class);

    private static final ObjectMapper objectMapper = new ObjectMapper().enable(JsonParser.Feature.ALLOW_SINGLE_QUOTES);

    public KqlDbSinkConfig(ConfigDef config, Map<String, String> parsedConfig) {
        super(config, parsedConfig);
    }

    public KqlDbSinkConfig(Map<String, String> parsedConfig) {
    ...
    private static void defineConnectionConfigs(@NotNull ConfigDef result) {
        ...
        result
                .define(
                        ...
                        Width.MEDIUM,
                        KQL_DB_CONNECTION_STRING_DISPLAY)
                .define(
