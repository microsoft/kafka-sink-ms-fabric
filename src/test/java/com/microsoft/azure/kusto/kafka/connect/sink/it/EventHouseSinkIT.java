...
import com.microsoft.azure.kusto.kafka.connect.sink.it.containers.EventHouseKafkaConnectContainer;
...
class EventHouseSinkIT {
    ...
    private static final EventHouseKafkaConnectContainer connectContainer = new EventHouseKafkaConnectContainer(confluentVersion)
            .withNetwork(network)
